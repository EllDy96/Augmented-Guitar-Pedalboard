    ...
    if(check_error):
        ...
        class Canvas(app.Canvas):
            ...
            def on_timer(self, event):
                ...
                try:
                    k = 20 #number of new points to be displayed (k new points will be added and the first 20 points will be delated)
                    k_osc = 256
                    i=k
                    ...
                    try:
                        ...
                        client1.send_message('/channel_0_1', str(post_hampeling))  # g01_h client2 # forse il .microsecond potrebbe essere un problema
