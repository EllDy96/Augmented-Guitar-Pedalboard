...
def RNN_input_preprocessing(raw_dataframe, min_values, max_values,fs= 1000): 
    '''
    ...
    rms_window_size=200 #numero di campioni su cui effettuare la convoluzione per il calcolo del RMS
    ...
    #print(' The number of nan in this window: ', raw_dataframe.isna().sum().sum()) 
    ...
    print(' Initial shape ', df_RMS.shape) # '\n', df_RMS, '\n', type(df_RMS))
    ...
    custom_scaler.fit([max_values, min_values])
    df_RMS= custom_scaler.transform(df_RMS)
    ...
    #print('The final dataFrame:' , df_RMS)
